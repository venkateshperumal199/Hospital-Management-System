...
<body>
	...
	<form action="OprRecordDelete">

		<table>
			<tr>
				<td><label path="oprUsername">Operator's User Name :</label></td>
				<td><input type="text" name="oprUsername" /></td>
			</tr>
			...
			<tr>
				<td colspan="10" align="left"><input type="submit"
					value="Delete Operator's Record" /></td>
			</tr>
		</table>
