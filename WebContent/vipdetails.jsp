...
ResultSet rs=stmt.executeQuery("SELECT p.patient_id, CONCAT(p.first_name,p.last_name)AS pname,a.bed_number FROM Patient p INNER JOIN AdmittedPatients a ON a.patient_id = p.patient_id INNER JOIN Wards w ON w.ward_id = a.ward_id WHERE w.ward_type = 'VIP'");
while(rs.next())
{
