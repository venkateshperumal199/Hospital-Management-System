...
<body>
	...
	<form action="EmergencyManagerRecdUpdate">

		<table>
			<tr>
				<td><label path="emUsername">Emergency Manager User Name :</label></td>
				<td><input type="text" name="emUsername" required /></td>
			</tr>
			...
			<tr>
				<td colspan="10" align="left"><input type="submit"
					value="Update Emergency Manager Record" /></td>
			</tr>
		</table>
